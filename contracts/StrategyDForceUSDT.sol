...
contract StrategyDForceUSDT {
  ...
  address public want; //// = address(0xdAC17F958D2ee523a2206206994597C13D831ec7); // USDT
  ...
  address public constant weth = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2); // used for df <> weth <> usdt route
